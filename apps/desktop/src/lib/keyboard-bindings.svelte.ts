...
export const EDITABLE_SHORTCUT_ACTIONS: EditableShortcutAction[] = [
  ...
  { id: "toggleSourceScreen", label: "Toggle screen", description: "Turns the source off and on mid-recording, or picks it for the next one.", category: "app", nativeBackground: false },
  { id: "toggleSourceMicrophone", label: "Toggle microphone", description: "Turns the source off and on mid-recording, or picks it for the next one.", category: "app", nativeBackground: false },
  { id: "toggleSourceSystemAudio", label: "Toggle system audio", description: "Turns the source off and on mid-recording, or picks it for the next one.", category: "app", nativeBackground: false },
