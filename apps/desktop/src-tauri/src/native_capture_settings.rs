use capture_types::{
    ...
    default_audio_transcription_settings, default_capture_safety_settings,
    default_developer_options_enabled, default_follow_timeline_live, default_idle_timeout_seconds,
    default_metadata_settings, default_microphone_activity_sensitivity,
    default_native_capture_debug_logging_enabled, default_ocr_settings,
    default_ocr_tesseract_char_whitelist, default_ocr_tesseract_page_segmentation_mode,
    default_ocr_tesseract_preprocess_mode, default_ocr_tesseract_upscale_factor,
    default_pause_capture_on_inactivity, default_preview_cache_ttl_seconds,
    default_privacy_settings, default_speaker_analysis_model_id, default_speaker_analysis_settings,
    default_speaker_analysis_timeout_seconds, default_system_audio_activity_sensitivity,
    default_video_bitrate, AudioSpeechDetectionSettings, AudioSpeechDetector,
    ...
    ScreenResolutionPreset, SpeakerAnalysisSettings, UpdateRecordingSettingsRequest,
...
pub(crate) fn validate_recording_settings_with_resolution_support(
    ...
    Ok(RecordingSettings {
        ...
        privacy,
        capture_safety: request.capture_safety,
...
fn load_recording_settings_from_path_with_resolution_support(
    ...
    validate_recording_settings_with_resolution_support(
        UpdateRecordingSettingsRequest {
            ...
            capture_safety: parsed.capture_safety,
