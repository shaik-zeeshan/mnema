...
- Sensitive Capture Protection V1 stays inside the app-only privacy model from ADR 0005 and ADR 0007. Do not add URL/domain/title/private-window/password-field/browser-extension filtering to live privacy; use App Privacy Exclusion, Browser Capture Disclosure, Exclude Current App, Pause Recording, and confirmed Delete Recent Capture recovery instead.
