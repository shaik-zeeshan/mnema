...
- **`mnema-cli` sidecar required** for any `apps/desktop/src-tauri` cargo invocation: run `bun scripts/prepare-mnema-cli-sidecar.mjs debug` first on a clean checkout.
